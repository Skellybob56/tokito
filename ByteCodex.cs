...
internal static class ByteCodex
{
	...
	public static byte[] Compress(byte[] tokens, byte? minimumPairIndex)
	{
	...
	public static byte[] Decompress(byte[] compressed, byte? minimumPairIndex)
	{
